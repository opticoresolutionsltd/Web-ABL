<div class="border rounded-circle scroll-top"><a class="btn-wsp" href="https://api.whatsapp.com/send?phone=+Yournumberhere" target="_blank" style="width: 40px;height: 40px;margin-right: -10px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" class="icono" style="width: 24px;height: 24px;margin-bottom: 30px;">
        ...
        </svg></a><a class="d-flex justify-content-center align-items-center" id="scroll-top" href="#"><i class="bi bi-arrow-up-short" style="margin-top: 8px;"></i></a></div>
    ...
    <div class="container">
        <div class="row gy-3">
            ...
            <div class="col-sm-6 col-lg-3 d-flex"><i class="bi bi-telephone icon"></i>
                <div>
                    <h4>Contact</h4>
                    <p><strong>Phone:</strong><span>+1 5589 55488 55</span><br><strong>Email:</strong><span>asad@alliancebuildersltd.org</span><br></p>
                </div>
            </div>
